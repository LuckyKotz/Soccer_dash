...
score[['Team1_goals', 'Team2_goals', 'Team1_1H', 'Team2_1H']] = score['Unnamed: 3'].str.split(r'\:|\(', expand=True)
score['Team2_1H'] = score['Team2_1H'].str.replace(r'\)', '', regex=True)
...
columns_kol_vo = ['Team1_goals', 'Team2_goals', 'Team1_1H', 'Team2_1H',
...
home_avg = home_avg.rename(columns={'Team1_goals': 'goals_home', 'Team2_goals': 'goals_opponent_home',
                                    'Team1_1H': '_1H_home', 'Team2_1H': '_1H_opponent_home',
...
away_avg = away_avg.rename(columns={'Team1_goals': 'goals_opponent_away', 'Team2_goals': 'goals_away',
                                    'Team1_1H': '_1H_opponent_away', 'Team2_1H': '_1H_away',
